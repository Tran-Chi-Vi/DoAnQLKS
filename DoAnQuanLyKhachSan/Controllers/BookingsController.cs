...
namespace DoAnQuanLyKhachSan.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,CustomerId,RoomId,CheckInDate,CheckOutDate,Status")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,CustomerId,RoomId,CheckInDate,CheckOutDate,Status")] Booking booking)
        {
            if (ModelState.IsValid)
            {
