...
namespace DoAnQuanLyKhachSan.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomId,RoomNumber,FloorId,RoomType,Status")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomId,RoomNumber,FloorId,RoomType,Status")] Room room)
        {
            if (ModelState.IsValid)
            {
